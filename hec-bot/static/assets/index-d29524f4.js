...
(function () {
  ...
  new MutationObserver(o => {
    for (const i of o)
      if (i.type === "childList")
        for (const s of i.addedNodes) s.tagName === "LINK" && s.rel === "modulepreload" && t(s)
  }).observe(document, {
    childList: !0,
    subtree: !0
  });
              ...
              return m = P, (h = [{
                ...
                value: function () {
                  ...
                  document.addEventListener("click", function (u) {
                    var f = u.target,
                      O = f.closest(T.selector),
                      C = f.closest(".hs-accordion-toggle"),
                ...
                value: function (T) {
                  var u = this,
                    f = T.querySelector(".hs-accordion-content");
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
              ...
              }]) && g(h.prototype, p), Object.defineProperty(h, "prototype", {
                writable: !1
              }), T
            }(c(765).Z);
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
            ...
            var _ = function (A) {
              ...
              return P = C, T = [{
                ...
                value: function () {
                  ...
                  document.addEventListener("click", function (j) {
                    var R = j.target,
                      q = R.closest(S.selector),
                      B = R.closest(".hs-dropdown-menu");
                ...
                value: function () {
                  var S = this,
                    j = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null,
                ...
                value: function (S) {
                  var j = this,
                    ...
                    q = S.querySelector(".hs-dropdown-menu"),
                    B = function () {
                ...
                value: function (S) {
                  var j = S.querySelector(".hs-dropdown-menu"),
                    ...
                    q = j.querySelector("a:focus"),
                    B = R.findIndex(function (N) {
                      return N === q
                    });
                ...
                value: function (S, j) {
                  var R = this,
                    q = x(S.querySelector(".hs-dropdown-menu").querySelectorAll("a")),
                    B = function () {
              ...
              }], T && L(P.prototype, T), Object.defineProperty(P, "prototype", {
                writable: !1
              }), C
            }(d.Z);
          ...
          284: (s, l, c) => {
            ...
            var L = function (m) {
              ...
              return h = T, (p = [{
                ...
                value: function (u) {
                  var f = this,
                    O = parseInt(this.getClassProperty(u, "--auto-hide", "0"));
                ...
                value: function (u) {
                  var f, O = this,
                    C = u.getAttribute("data-hs-overlay-backdrop-container") || !1,
              ...
              return m = P, (h = [{
                ...
                value: function (T) {
                  var u = T.ev,
                    ...
                    q = parseInt(C.getBoundingClientRect().top) - j - R,
                    B = C.offsetHeight;
                  if (q <= 0 && q + B > 0) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
            ...
            var m = function (h) {
                ...
                value: function (f) {
                  ...
                  if (O) {
                    var C = d(O.querySelectorAll(this.selector)).filter(function (R) {
                      ...
                      S = O.querySelector("button:focus"),
                      j = C.findIndex(function (R) {
                        return R === S
                      });
              ...
              }]) && k(p.prototype, _), Object.defineProperty(p, "prototype", {
                writable: !1
              }), u
            }(c(765).Z);
          ...
          185: (s, l, c) => {
            ...
            var m = function (h) {
              ...
              return p = u, (_ = [{
                ...
                value: function (f) {
                  var O = this,
                    C = f.querySelector(".hs-tooltip-toggle"),
                    S = f.querySelector(".hs-tooltip-content"),
                    j = this.getClassProperty(f, "--placement"),
          ...
          765: (s, l, c) => {
            ...
            var d = function () {
              ...
              }], x && a(k.prototype, x), Object.defineProperty(k, "prototype", {
                writable: !1
              }), g
            }()
          },
          714: (s, l, c) => {
            ...
            function u(b, y, $) {
              ...
              var H, z, Q = g(y),
                V = g(y) && function (ee) {
                  var Ee = ee.getBoundingClientRect(),
                    ae = L(Ee.width) / ee.offsetWidth || 1,
            ...
            function S(b, y) {
              ...
              y === void 0 && (y = []);
              var H = C(b),
                z = H === (($ = b.ownerDocument) == null ? void 0 : $.body),
                Q = a(H),
                V = z ? [Q].concat(Q.visualViewport || [], T(H) ? H : []) : H,
                W = y.concat(V);
                    ...
                    forceUpdate: function () {
                      if (!ae) {
                        ...
                        if (Te(Ce, ve)) {
                          ...
                          for (var fe = 0; fe < ee.orderedModifiers.length; fe++)
                            if (ee.reset !== !0) {
                              var ye = ee.orderedModifiers[fe],
                                ce = ye.fn,
                                ue = ye.options,
                                de = ue === void 0 ? {} : ue,
                                ge = ye.name;
            ...
            function oe(b) {
              ...
              ae = le.x, pe = le.y;
              var Ce = V.hasOwnProperty("x"),
                ve = V.hasOwnProperty("y"),
                fe = re,
                ye = B,
                ce = window;
              if (te) {
              ...
              var be, Me = Object.assign({
                  position: W
                }, te && He),
                Re = ne === !0 ? function (Ze) {
                  var Ke = Ze.x,
                    st = Ze.y,
                    We = window.devicePixelRatio || 1;
                  return {
                    x: L(Ke * We) / We || 0,
                    y: L(st * We) / We || 0
                  }
            ...
            function fn(b, y) {
              return y === lt ? Ft(function ($) {
                ...
                var H, z = _($),
                  Q = h($),
                  V = (H = $.ownerDocument) == null ? void 0 : H.body,
            ...
            function Et(b, y) {
              ...
              var $ = y,
                H = $.placement,
                z = H === void 0 ? b.placement : H,
                Q = $.boundary,
                V = Q === void 0 ? "clippingParents" : Q,
                W = $.rootBoundary,
                K = W === void 0 ? lt : W,
                te = $.elementContext,
                ne = te === void 0 ? me : te,
                ...
                ae = $.padding,
                he = ae === void 0 ? 0 : ae,
                pe = dn(typeof he != "number" ? he : pn(he, Ae)),
                le = ne === me ? "reference" : me,
                Ce = b.rects.popper,
                ve = b.elements[Ee ? le : ne],
                fe = function (Re, Ze, Ke) {
                ...
                }(d(ve) ? ve : ve.contextElement || _(b.elements.popper), V, K),
                ye = m(b.elements.reference),
                ce = X({
                  reference: ye,
                  element: Ce,
                  strategy: "absolute",
              ...
              if (ne === me && be) {
                ...
                Object.keys(ge).forEach(function (Re) {
                  var Ze = [ie, N].indexOf(Re) >= 0 ? 1 : -1,
                    Ke = [B, N].indexOf(Re) >= 0 ? "y" : "x";
                  ge[Re] += Me[Ke] * Ze
                })
              }
              return ge
              ...
              defaultModifiers: [{
                ...
                effect: function (b) {
                  ...
                  return Q && te.forEach(function (ne) {
                    ...
                    }), W && K.addEventListener("resize", $.update, Pe),
                    function () {
                ...
                effect: function (b) {
                  ...
                  return Object.assign(y.elements.popper.style, $.popper), y.styles = $, y.elements.arrow && Object.assign(y.elements.arrow.style, $.arrow),
                    function () {
                  ...
                  var y = b.state,
                    ...
                    V = ze.reduce(function (ne, ee) {
                      return ne[ee] = function (Ee, ae, he) {
                        var pe = Be(Ee),
                          le = [re, B].indexOf(pe) >= 0 ? -1 : 1,
                          Ce = typeof he == "function" ? he(Object.assign({}, ae, {
                            placement: Ee
                          })) : he,
                          ve = Ce[0],
                          fe = Ce[1];
                    ...
                    for (var z = $.mainAxis, Q = z === void 0 || z, V = $.altAxis, W = V === void 0 || V, K = $.fallbackPlacements, te = $.padding, ne = $.boundary, ee = $.rootBoundary, Ee = $.altBoundary, ae = $.flipVariations, he = ae === void 0 || ae, pe = $.allowedAutoPlacements, le = y.options.placement, Ce = Be(le), ve = K || (Ce !== le && he ? function (Ge) {
                        ...
                        return Ge.concat(Be(Xe) === Ye ? function (vt, ft) {
                          ...
                          var et = ft,
                            ...
                            _t = et.rootBoundary,
                            Yt = et.padding,
                            Jt = et.flipVariations,
                            wt = et.allowedAutoPlacements,
                            Kt = wt === void 0 ? ze : wt,
                            jt = Oe(Bt),
                            Nt = jt ? Jt ? it : it.filter(function (rt) {
                              return Oe(rt) === jt
                            }) : Ae,
                            kt = Nt.filter(function (rt) {
                ...
                fn: function (b) {
                  var y = b.state,
                    ...
                    ye = Le(Ce),
                    ce = ye === "x" ? "y" : "x",
                    ue = y.modifiersData.popperOffsets,
                    de = y.rects.reference,
                    ge = y.rects.popper,
                    be = typeof pe == "function" ? pe(Object.assign({}, y.rects, {
                      placement: y.placement
                    })) : pe,
                    Me = typeof be == "number" ? {
                      mainAxis: be,
                  ...
                  if (ue) {
                    if (Q) {
                      var Ke, st = ye === "y" ? B : re,
                        We = ye === "y" ? N : ie,
                        Ie = ye === "y" ? "height" : "width",
                        qe = ue[ye],
                        ke = qe + le[st],
                        ut = qe - le[We],
                        Fe = ae ? -ge[Ie] / 2 : 0,
                        Ge = ve === De ? de[Ie] : ge[Ie],
                        Xe = ve === De ? -ge[Ie] : -de[Ie],
                        vt = y.elements.arrow,
                        ft = ae && vt ? f(vt) : {
                          width: 0,
                          height: 0
                ...
                fn: function (b) {
                  var y, $ = b.state,
                    ...
                    z = b.options,
                    Q = $.elements.arrow,
                    V = $.modifiersData.popperOffsets,
                    W = Be($.placement),
                    K = Le(W),
                    te = [re, ie].indexOf(W) >= 0 ? "height" : "width";
                  if (Q && V) {
                    var ne = function (ge, be) {
                        return dn(typeof (ge = typeof ge == "function" ? ge(Object.assign({}, be.rects, {
                          placement: be.placement
                        })) : ge) != "number" ? ge : pn(ge, Ae))
                      }(z.padding, $),
                      ee = f(Q),
                      Ee = K === "y" ? B : re,
                      ae = K === "y" ? N : ie,
                      he = $.rects.reference[te] + $.rects.reference[K] - V[K] - $.rects.popper[te],
                      pe = V[K] - $.rects.reference[K],
                      le = q(Q),
                ...
                fn: function (b) {
                  var y = b.state,
                    ...
                    H = y.rects.reference,
                    z = y.rects.popper,
                    Q = y.modifiersData.preventOverflow,
                    V = Et(y, {
      ...
      o.d = (s, l) => {
        for (var c in l) o.o(l, c) && !o.o(s, c) && Object.defineProperty(s, c, {
          enumerable: !0,
          get: l[c]
        })
...
function Mr(r) {
  ...
  return {
    c() {
      e = E("div"), e.innerHTML = '<h1 class="text-3xl font-bold text-gray-800 sm:text-4xl dark:text-white">Welcome to Hectronic ChatBot</h1> <p class="mt-3 text-gray-600 dark:text-gray-400">Let’s make fuel tracking simple. I’m here to help you monitor, check, and stay in control.</p> <br>', v(e, "class", "max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto text-center")
    },
    m(n, t) {
      U(n, e, t)
    },
...
function Jr(r) {
  ...
  return {
    c() {
      e = E("li"), n = E("img"), o = Z(), i = E("div"), c && c.c(), or(n.src, t = "/hectronic.svg") || v(n, "src", t), v(n, "class", "flex-shrink-0 w-[2.375rem] h-[2.375rem] "), v(n, "alt", "agent logo"), v(i, "class", "space-y-3 overflow-x-auto overflow-y-hidden"), v(e, "class", "max-w-4xl py-2 px-4 sm:px-6 lg:px-8 mx-auto flex gap-x-2 sm:gap-x-4")
    },
    m(a, d) {
...
function eo(r) {
  ...
  return s = new pt({
    ...
    c() {
      e = E("li"), n = E("img"), o = Z(), i = E("div"), J(s.$$.fragment), or(n.src, t = "/hectronic.svg") || v(n, "src", t), v(n, "class", "flex-shrink-0 w-[2.375rem] h-[2.375rem] animate-bounce "), v(n, "alt", "agent logo"), v(i, "class", "space-y-3"), v(e, "class", "max-w-4xl py-2 px-4 sm:px-6 lg:px-8 mx-auto flex gap-x-2 sm:gap-x-4")
    },
    m(c, a) {
...
function io(r) {
  let e, n, t, o, i, s, l, c, a, d, g, k = _e(r[2]),
    x = [];
...
function so(r, e, n) {
  let {
    ...
    df: o
  } = e, i = JSON.parse(o), s = i.length > 0 ? Object.keys(i[0]) : [];
  return r.$$set = l => {
...
function ao(r, e, n) {
  let {
    fig: t
  } = e, o = JSON.parse(t), i = Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15);
  return sr(() => {
    Plotly.newPlot(document.getElementById(i), o, {
      responsive: !0
    })
  }), r.$$set = s => {
...
function Vn(r) {
  let e, n, t, o;
  const i = [Eo, To, Lo, Oo, So, $o, xo, ko, wo],
    s = [];
...
function Ko(r) {
  ...
  t = new Rr({});
  let L = r[1] && r[1].type == "question_list" && !r[7] && Bn(r),
    m = _e(r[2]),
    h = [];
...
function Xo(r, e, n) {
  ...
  const k = () => n(0, d = !0),
    x = () => n(0, d = !1),
    D = L => L.type === "question_cache" ? s(L.id) : void 0;
  return r.$$set = L => {
...
function oi(r) {
  let e, n, t, o, i, s, l, c, a, d, g, k, x, D, L, m, h, p, _, A, P, T, u, f, O, C = _e(r[3]),
    S = [];
  for (let j = 0; j < C.length; j += 1) S[j] = Wn(Zn(r, C, j));
  return {
    c() {
      var j;
      e = E("div"), n = E("div"), t = E("div"), o = E("div"), i = E("h2"), i.textContent = "Add Training Data", s = Z(), l = E("button"), l.innerHTML = '<span class="sr-only">Close</span> <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.258206 1.00652C0.351976 0.912791 0.479126 0.860131 0.611706 0.860131C0.744296 0.860131 0.871447 0.912791 0.965207 1.00652L3.61171 3.65302L6.25822 1.00652C6.30432 0.958771 6.35952 0.920671 6.42052 0.894471C6.48152 0.868271 6.54712 0.854471 6.61352 0.853901C6.67992 0.853321 6.74572 0.865971 6.80722 0.891111C6.86862 0.916251 6.92442 0.953381 6.97142 1.00032C7.01832 1.04727 7.05552 1.1031 7.08062 1.16454C7.10572 1.22599 7.11842 1.29183 7.11782 1.35822C7.11722 1.42461 7.10342 1.49022 7.07722 1.55122C7.05102 1.61222 7.01292 1.6674 6.96522 1.71352L4.31871 4.36002L6.96522 7.00648C7.05632 7.10078 7.10672 7.22708 7.10552 7.35818C7.10442 7.48928 7.05182 7.61468 6.95912 7.70738C6.86642 7.80018 6.74102 7.85268 6.60992 7.85388C6.47882 7.85498 6.35252 7.80458 6.25822 7.71348L3.61171 5.06702L0.965207 7.71348C0.870907 7.80458 0.744606 7.85498 0.613506 7.85388C0.482406 7.85268 0.357007 7.80018 0.264297 7.70738C0.171597 7.61468 0.119017 7.48928 0.117877 7.35818C0.116737 7.22708 0.167126 7.10078 0.258206 7.00648L2.90471 4.36002L0.258206 1.71352C0.164476 1.61976 0.111816 1.4926 0.111816 1.36002C0.111816 1.22744 0.164476 1.10028 0.258206 1.00652Z" fill="currentColor"></path></svg>', c = Z(), a = E("span"), a.textContent = "Training Data Type", d = Z(), g = E("div");
...
function fi(r) {
  let e, n, t, o, i, s, l, c, a, d, g, k, x, D, L, m, h, p, _, A, P, T, u, f, O, C, S, j = r[2] + 1 + "",
    R, q, B = Math.min(r[3], r[7].length) + "",
    N, ie, re, Ye, Ae, De, Ve, lt, me, it, ze, at, Lt, Tt, Te = r[6] && Kn(r),
    ct = _e(r[8]),
    Pe = [];
...
function di(r, e, n) {
  ...
  } = e, s = JSON.parse(t), l = s.length > 0 ? Object.keys(s[0]) : [], c = 10, a = 1, d = Math.ceil(s.length / c), g = (a - 1) * c, k = a * c, x = s.slice(g, k);
  const D = () => {
      a > 1 && n(16, a--, a)
    },
    L = () => {
...
function ki(r) {
  ...
  return r[4] !== void 0 && (a.question_asked = r[4]), r[5] !== void 0 && (a.thinking = r[5]), r[0] !== void 0 && (a.marked_correct = r[0]), e = new ei({
    props: a
  }), At.push(() => on(e, "question_asked", s)), At.push(() => on(e, "thinking", l)), At.push(() => on(e, "marked_correct", c)), {
    c() {
      J(e.$$.fragment)
    },
    m(d, g) {
...
function Si(r, e, n) {
  ...
  function k(q) {
    g(), _({
      type: "user_question",
      question: q
    }), n(4, s = !0), f("generate_sql", "GET", {
      question: q
    }).then(_).then(B => {
      B.type === "sql" && (window.location.hash = B.id, f("run_sql", "GET", {
        id: B.id
      }).then(_).then(N => {
        N.type === "df" && f("generate_plotly_figure", "GET", {
          id: N.id
        }).then(_).then(ie => {
          ie.type === "plotly_figure" && (n(7, d = [...d, {
            question: q,
            id: ie.id
          }]), f("generate_followup_questions", "GET", {
            id: ie.id
          }).then(_))
        })
      }))
  ...
  function x(q) {
    _({
      ...
      B.type === "df" && f("generate_plotly_figure", "GET", {
        id: B.id
      }).then(_).then(N => {
        N.type === "plotly_figure" && f("generate_followup_questions", "GET", {
          id: N.id
        }).then(_)
      })
    })
  ...
  function h(q) {
    window.location.hash = q, n(6, a = "chat"), g(), n(4, s = !0), f("load_question", "GET", {
      id: q
    }).then(_)
  }

  function p(q) {
    n(3, i = null), f("remove_training_data", "POST", {
      id: q
    }).then(B => {
  ...
  async function f(q, B, N) {
    try {
      ...
      let ie = "",
        re;
      if (B === "GET") ie = Object.entries(N).filter(([Ae, De]) => Ae !== "endpoint" && Ae !== "addMessage").map(([Ae, De]) => `${encodeURIComponent(Ae)}=${encodeURIComponent(De)}`).join("&"), re = await fetch(`/api/v0/${q}?${ie}`);
      else {
      ...
      if (!re.ok) throw new Error("The server returned an error. See the server logs for more details.");
